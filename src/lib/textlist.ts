...
本調査は工学院大学応用経済分析研究室が実施するお金の分配に関するアンケート調査です。¥n
アンケートの概要やその流れ、注意事項等の事前説明は、ランサーズ上にある本調査の募集ページに記載しております。¥n`;

const T_text2 = `ご質問や不明点がございましたら、工学院大学情報学部応用経済分析研究室の¥n
齋野(j319138@ns.kogakuin.ac.jp)までご連絡ください。¥n
この調査研究やその手順、リスクや利点についてご質問や苦情がある場合は、¥n
研究室担当教員矢崎(yasaki@cc.kogakuin.ac.jp)までご連絡ください。¥n
